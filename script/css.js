...
function render() {
  document.getElementById('questionAmount').innerHTML = questionsCSS.length;
...
function nextQuestion() {
  ...
  if (currentQuestion >= questionsCSS.length) {
    ...
    let percent = ((currentQuestion + 1) / questionsCSS.length) * 100;
...
function showEndscreen() {
  ...
  document.getElementById('questionAmountResult').innerHTML = questionsCSS.length;

...
function render() {
  document.getElementById('questionAmount').innerHTML = questionsHTML.length;
...
function nextQuestion() {
  ...
  if (currentQuestion >= questionsHTML.length) {
    ...
    let percent = ((currentQuestion + 1) / questionsHTML.length) * 100;
...
function showEndscreen() {
  ...
  document.getElementById('questionAmountResult').innerHTML = questionsHTML.length;
